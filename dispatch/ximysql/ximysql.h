/* ximysql.h
 *
 * Xplico System dispatcher module for MySQL DB
 *
 * $Id: $
 *
...
#ifndef __XIMYSQL_H__
#define __XIMYSQL_H__
...
#endif
#define XPCAP_DATE          "FROM_UNIXTIME(%lu)"

/* geomap */
#define XS_GEA_TMPDIR_PATH XS_DB_INSTALL_DIR"/pol_%d/tmp"
#define XS_GEA_SEM         "/gea_pol_%i"  /* lite.h dema.h */
