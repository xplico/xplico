...
<td class="from" ><?php echo str_replace('>', '&gt;', str_replace('<', '&lt;', $mgcp['Mgcp']['from_addr'])); ?></td><td><a href="#" onclick="popupVoip('/mgcps/caller_play/<?php echo $mgcp['Mgcp']['id']?>','scrollbar=auto'); return false"><?php echo __('play'); ?></a></td>
</tr>
<tr>
<td class="header-title"><?php echo __('To:'); ?>&nbsp;</td>
<td class="to" ><?php echo str_replace('>', '&gt;', str_replace('<', '&lt;', $mgcp['Mgcp']['to_addr'])); ?></td></td><td><a href="#" onclick="popupVoip('/mgcps/called_play/<?php echo $mgcp['Mgcp']['id']?>','scrollbar=auto'); return false"><?php echo __('play'); ?></a></td>
</tr>
<tr>
...
<td class="date pinfo" ><a href="#" onclick="popupVetrina('/mgcps/info/<?php echo $mgcp['Mgcp']['id']?>','scrollbar=auto'); return false"><?php echo __('info.xml'); ?></a><div class="ipcap"><?php echo $this->Html->link('pcap', 'pcap/'); ?></div></td><td></td>
</tr>
</tbody></table>
</div>
