...
<td class="from" ><?php echo $rtp['Rtp']['from_addr']; ?></td><td><a href="#" onclick="popupVoip('/rtps/caller_play/<?php echo $rtp['Rtp']['id']?>','scrollbar=auto'); return false"><?php echo __('play'); ?></a></td>
</tr>
<tr>
<td class="header-title"><?php echo __('To:'); ?>&nbsp;</td>
<td class="to" ><?php echo $rtp['Rtp']['to_addr']; ?></td></td><td><a href="#" onclick="popupVoip('/rtps/called_play/<?php echo $rtp['Rtp']['id']?>','scrollbar=auto'); return false"><?php echo __('play'); ?></a></td>
</tr>
<tr>
...
<td class="date pinfo" ><a href="#" onclick="popupVetrina('/rtps/info/<?php echo $rtp['Rtp']['id']?>','scrollbar=auto'); return false"><?php echo __('info.xml'); ?></a><div class="ipcap"><?php echo $this->Html->link('pcap', 'pcap/'); ?></div></td><td></td>
</tr>
</tbody></table>
</div>
