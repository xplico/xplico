 ...
 */
	Configure::write('Session.cookie', 'Xplico');
 ...
 */
	Configure::write('Security.salt', 'www.capanalysis.net 3aaaaguVoUuALETORYbWSALTniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '11229309657453542496749683645');
