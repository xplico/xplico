...
class WebsController extends AppController {
        ...
        function index($id = null) {
                ...
                $i = stripos($uri, "http://");
                if ($i === false) {
                    $this->Session->setFlash(__('For a complete view of html page set your browser to use Proxy, and point it to Web server.', true));
                }
                else {
                    $this->Session->setFlash(__('This version can be inaccurate in displaying Web pages.', true));
                }
		...
		if ($this->Session->check('host_id')) {
                ...
                if (!empty($this->data)) {
                    $value = $this->data['webcontent']['type'];
                    switch ($value) {
                    case 0:
                        $filtr = 'text/html%';
                        break;
                    ...
                    if ($this->data['webcontent']['search'] != "") {                        
                        $rsrc_url = $this->data['webcontent']['search'];
                    }
                    else
                        $rsrc_url = null;
                }
        ...
        function images($id = null) {
                ...
                if (!empty($this->data)) {
                    $rsrc_url = $this->data['Search']['label'];
