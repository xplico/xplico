...
<div class="generic">
<h2><?php __('Article from'); ?> <?php echo str_replace('>', '&gt;', str_replace('<', '&lt;', $mailObj['from']))?></h2>
...
<td class="date pinfo"><a href="#" onclick="popupVetrina('/nntp_groups/info','scrollbar=auto'); return false"><?php __('info.xml'); ?></a><div class="ipcap"><?php echo $html->link('pcap', 'pcap/'); ?></div></td>
</tr>
</tbody></table>
